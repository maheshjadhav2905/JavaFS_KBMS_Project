        ...
        <div class="adminPage">
          ...
          <form action="CustomerUpdate" method="post">
                             ...
                             <div>
                               ...
                               <input type="text" name = "name" class="form-control w-50" value=><br>
                             </div>
                             <div>
                               <input type="hidden" name = "login_id" class="form-control w-50" value=<%=request.getParameter("login_id")%>><br>
                             </div>
                                              <div>
